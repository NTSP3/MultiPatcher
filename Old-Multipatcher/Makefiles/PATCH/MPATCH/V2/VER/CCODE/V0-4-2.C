...
void MultiInstalls() {
  ...
  cprintf("    To quit the MultiPatcher program, press F3.                                 ");
  cprintf("                                                                                ");
  if (nVar == '2') MultiInsGrp01();
  else if (nVar == '3') MultiInsGrp02();
...
void EnterLoopKey4() {
  ...
  if (yn13 == 0x3D) {
    ...
    if (yn13 == 72) { // Up arrow key
      ...
      if (cBar == '1') EnterLoopKey4(); // Temp // Enter the last command here (future)
      ...
      else if (cBar == '2') EnterLoopKey4(); // Temp // Write next
