...
void MultiInstalls() {
  ...
  else if (cBar == '3') MultiInsGrp03();
  else if (cBar == '4') MultiInsGrp04();
  else if (cBar == '5') MultiInsGrp05();
  else if (cBar == '6') MultiInsGrp06();
  else if (cBar == '7') MultiInsGrp07();
  else if (cBar == '8') MultiInsGrp08();
...
void EnterLoopKey4() {
  ...
  if (yn13 == 13) MultiInstalls();
    ...
    if (yn13 == 72) { // Up arrow key
      ...
      if (cBar == '1') MultiInsGrp08();
      else if (cBar == '2') MultiInsGrp01();
      else if (cBar == '3') MultiInsGrp02();
      else if (cBar == '4') MultiInsGrp03();
      else if (cBar == '5') MultiInsGrp04();
      else if (cBar == '6') MultiInsGrp05();
      else if (cBar == '7') MultiInsGrp06();
      else if (cBar == '8') MultiInsGrp07();

    }

    else if (yn13 == 80) { // Down arrow key

      if (cBar == '1') MultiInsGrp02();
      else if (cBar == '2') MultiInsGrp03();
      else if (cBar == '3') MultiInsGrp04();
      else if (cBar == '4') MultiInsGrp05();
      else if (cBar == '5') MultiInsGrp06();
      else if (cBar == '6') MultiInsGrp07();
      else if (cBar == '7') MultiInsGrp08();
      else if (cBar == '8') MultiInsGrp01();
