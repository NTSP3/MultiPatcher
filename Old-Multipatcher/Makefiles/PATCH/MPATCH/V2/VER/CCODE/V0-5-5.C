...
void UsrOptSelect1(); // Declare function for later use
void UsrOptSelect2(); // Declare function for later use
void UsrOptSelect3(); // Declare function for later use
void DevOptSelect1(); // Declare function for later use
void DevOptSelect2(); // Declare function for later use
void DevOptSelect3(); // Declare function for later use
void DevOptSelect4(); // Declare function for later use
void DevOptSelect5(); // Declare function for later use
...
void ProgramOption() {
  ...
  if (devmenu != '1') UsrOptSelect1();
  else if (devmenu == '1') DevOptSelect1();
  else exit(0);
...
//  delay(15);
  if (fbfmode == '1') getch();
  gotoxy(1, 4);
//  cprintf("ֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽ                                                     ");
  if (fbfmode == '1') getch();
  cprintf("                                                                                ");
  if (fbfmode == '1') getch();
  cprintf("                                                                                ");
...
//  textcolor(DARKGRAY);
  ...
  if (fbfmode == '1') getch();
//  textcolor(LIGHTGRAY);
  cprintf("ֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽ");
  if (fbfmode == '1') getch();
  gotoxy(1, 21);
  if (fbfmode == '1') getch();
  cprintf("                                                                                ");
  ...
  gotoxy(1, 3);
  if (fbfmode == '1') getch();
  cprintf("ֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽ");
  if (fbfmode == '1') getch();
  gotoxy(1, 22);
  if (fbfmode == '1') getch();
  textcolor(LIGHTGRAY);
  ...
  gotoxy(1, 3);
  if (fbfmode == '1') getch();
  cprintf("ֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽ");
  if (fbfmode == '1') getch();
  gotoxy(1, 23);
  if (fbfmode == '1') getch();
  ...
  gotoxy(1, 3);
  if (fbfmode == '1') getch();
  cprintf("ֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽֽ");
  if (fbfmode == '1') getch();
  gotoxy(1, 24);
  if (fbfmode == '1') getch();
  cprintf("                                                                                ");
...
void UserQuitCheck() {
  ...
  gotoxy (14, 8);
  if (fbfmode == '1') getch();
  cprintf("÷  MultiPatcher is not completely set up on your   ÷");
  if (fbfmode == '1') getch();
  if (denyani != '1') delay(75);
  gotoxy (14, 9);
  if (fbfmode == '1') getch();
  cprintf("÷  computer. If you quit Setup now, you will need  ÷");
  if (fbfmode == '1') getch();
  if (denyani != '1') delay(40);
  gotoxy (14, 10);
  if (fbfmode == '1') getch();
  cprintf("÷  to run Setup again to patch Windows files.      ÷");
  if (fbfmode == '1') getch();
  if (denyani != '1') delay(35);
  gotoxy (14, 11);
  if (fbfmode == '1') getch();
  ...
  gotoxy (14, 12);
  if (fbfmode == '1') getch();
  cprintf("÷     שTo continue Setup, press ENTER.             ÷");
  if (fbfmode == '1') getch();
  if (denyani != '1') delay(25);
  gotoxy (14, 13);
  if (fbfmode == '1') getch();
  cprintf("÷     שTo quit Setup, press F3.                    ÷");
  if (fbfmode == '1') getch();
  gotoxy (14, 14);
  if (fbfmode == '1') getch();
  if (denyani != '1') delay(20);
  ...
  if (fbfmode == '1') getch();
  if (denyani != '1') delay(20);
  cprintf("÷  F3=Quit  ENTER=Continue                         ÷");
  if (fbfmode == '1') getch();
  gotoxy (14, 16);
  if (fbfmode == '1') getch();
  if (denyani != '1') delay(20);
