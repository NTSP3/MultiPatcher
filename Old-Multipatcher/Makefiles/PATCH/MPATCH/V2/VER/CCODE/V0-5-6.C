...
void WhileLoopRule(); // Declare function for later use
void ProgramOption(); // Declare function for later use
void OpenQuickExit(); // Declare function for later use
...
void WhileLoopRule() {
  ...
  while(1) {
    ...
    if (currscr == '3' && (yn13 == 0 || yn13 == 0xE0)) {
       ...
       yn13 = getch();
       if (yn13 == 72) UsrOptSelect3();
       if (yn13 == 80) UsrOptSelect2();
       if (yn13 == 0x3D) OpenQuickExit();
    ...
    if (currscr == '4' && (yn13 == 0 || yn13 == 0xE0)) {
       ...
       yn13 = getch();
       if (yn13 == 72) UsrOptSelect1();
       if (yn13 == 80) UsrOptSelect3();
       if (yn13 == 0x3D) OpenQuickExit();
    ...
    if (currscr == '5' && (yn13 == 0 || yn13 == 0xE0)) {
       ...
       yn13 = getch();
       if (yn13 == 72) UsrOptSelect2();
       if (yn13 == 80) UsrOptSelect1();
       if (yn13 == 0x3D) OpenQuickExit();
