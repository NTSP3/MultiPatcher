...
int main(int argc, char* argv[]) {
  ...
  if (argc > 1 && strcmp(argv[1], "/runbymain::command-structoptions") == 0) {
  ...
  if (argc > 2 && strcmp(argv[2], "/??") == 0) {
    ...
    else if (strcmp(argv[2], "/LM") == 0 || strcmp(argv[2], "/lm") == 0 || strcmp(argv[2], "/lM") == 0 || strcmp(argv[2], "/Lm") == 0) {

      if (argc > 3) {

        printf("/LM: Not compatible with other options.");
        exit(0);
        printf("\r\nMultiPatcher Options: SETUP [/CL] [/NC] [/NH] [/TI] [/NI]\n");
        printf("\r\n   /CL         Load setup in monochrome mode");
        printf("\r\n   /NC         Skip file check");
    ...
    else if (strcmp(argv[2], "/developer-option-hidden-loadmenu-true") == 0) {
    ...
    if (argc > 3 && strcmp(argv[3], "/LM") == 0 || strcmp(argv[3], "/??") == 0) {
	...
	exit(0);
      ...
      if (argc > 4 && strcmp(argv[4], "/LM") == 0 || strcmp(argv[4], "/??") == 0) {
	...
	if (argc > 5 && strcmp(argv[5], "/LM") == 0 || strcmp(argv[5], "/??") == 0) {
	  ...
	  if (argc > 6 && strcmp(argv[6], "/LM") == 0 || strcmp(argv[6], "/??") == 0) {
	    ...
	    if (strcmp(argv[6], "/NC") == 0 || strcmp(argv[6], "/nc") == 0 || strcmp(argv[6], "/nC") == 0 || strcmp(argv[6], "/Nc") == 0) {
	    ...
	    else if (strcmp(argv[6], "/NH") == 0 || strcmp(argv[6], "/nh") == 0 || strcmp(argv[6], "/nH") == 0 || strcmp(argv[6], "/Nh") == 0 || strcmp(argv[6], "/TI") == 0 || strcmp(argv[6], "/ti") == 0 || strcmp(argv[6], "/Ti") == 0 || strcmp(argv[6], "/tI") == 0) {
	    ...
	    else if (strcmp(argv[6], "/NI") == 0 || strcmp(argv[6], "/ni") == 0 || strcmp(argv[6], "/nI") == 0 || strcmp(argv[6], "/Ni") == 0) {

	      denyani = '1';

	    }

	    else if (strcmp(argv[6], "/CL") == 0 || strcmp(argv[6], "/cl") == 0 || strcmp(argv[6], "/cL" ) == 0 || strcmp(argv[6], "/Cl" ) == 0) {
	    ...
	    else if (strcmp(argv[6], "/developer-option-show-inputcursor") == 0) {

	      devmode = '1';

	    }

	    else if (strcmp(argv[6], "/developer-option-enable-fbfmode") == 0) {
	    ...
	    if (argc > 7) {
	      ...
	      if (strcmp(argv[7], "/LM") == 0 || strcmp(argv[7], "/??") == 0) {
		...
		exit(0);
	      ...
	      else if (strcmp(argv[7], "/NH") == 0 || strcmp(argv[7], "/nh") == 0 || strcmp(argv[7], "/nH") == 0 || strcmp(argv[7], "/Nh") == 0 || strcmp(argv[7], "/TI") == 0 || strcmp(argv[7], "/ti") == 0 || strcmp(argv[7], "/Ti") == 0 || strcmp(argv[7], "/tI") == 0 || strcmp(argv[8], "/NH") == 0 || strcmp(argv[8], "/nh") == 0 || strcmp(argv[8], "/nH") == 0 || strcmp(argv[8], "/Nh") == 0 || strcmp(argv[8], "/TI") == 0 || strcmp(argv[8], "/ti") == 0 || strcmp(argv[8], "/Ti") == 0 || strcmp(argv[8], "/tI") == 0) {
  ...
  WhileLoopRule();
    ...
    printf("\r\nFunctionality program developed for MultiPatcher.\r\n");
    exit(0);
  ...
  while(1) {
    ...
    if (currscr == 17 && (yesorno == 0 || yesorno == 0xE0)) {
      ...
      if (yesorno == 0x3D) {
        ...
        fputs("", filechk);
        fclose(filechk);
        filechk = fopen(".\\utilfs\\RUNTIME.SWP", "a");
        fputs("00", filechk);
        if (denyani == '1') fputs("1", filechk);
        else fputs("0", filechk);
        if (nocolor == '1') fputs("1", filechk);
        else fputs("0", filechk);
        if (fbfmode == '1') fputs("1", filechk);
        else fputs("0", filechk);
        fclose(filechk);
        exit(0);
        sprintf(exitmod, ".\\utilfs\\cscrq.exe /runbymain:run-with-custom-settings /scr::1%s%s%s", optn3_0, optn4_0, optn5_0);
        returnv = system(exitmod);
        if (returnv == 1) printf("Returned 1");
        else if (returnv == 0) printf("Returned 0");
        delay(2500);
        exit(0);
        if (returnv == 1) exit(0);
        else if (returnv == 0) WelWinNoTimer();
...
void LoadScrsCheck() {
  ...
  if (chdir(".\\utilfs") != 0) {
    ...
    cprintf("\r\nMultiPatcher could not run because one or more required files were missing.");
    if (fbfmode == '1') getch();
  ...
  if (filechk == NULL) {
    ...
    cprintf("\r\nMultiPatcher could not run because the following file was not found:");
    if (fbfmode == '1') getch();
    cprintf("\r\n<utilities>\\NTDRV.UTL");
    if (fbfmode == '1') getch();
    cprintf("\r\nMake sure you have the necessary files and permissions.\r\n\n");
